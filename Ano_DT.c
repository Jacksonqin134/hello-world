...
{
	if(num > PARNUM)		// if num > 100,则退出函数
		return;
	ParValList[num] = data;		// ParValList.length = 100; num = [0,100],
...
void ANO_DT_ParListToParUsed(void)
{
	...
	// 高度PID控制初始化变量：alt_llevel : 高度速度环	alt_2level:高度环
