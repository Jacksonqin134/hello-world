/* This file is icm20602 driver file. ICM20602 is 6-axis motion tracking sensors and integrated 3-axis accelerater , 3-axis Gyro. */
...
#define MPU_WHOAMI_20602		0x12		/* ICM20602 addr value */

/* 
	主要几个部分：
	1. 映射寄存器地址
	2. 设置对应不同功能值（根据数据手册设定不同功能值）
	3. 引脚重定向
*/
